...
export function mockHistory() {
  return {
    ...
    stopped_months: 12,
    recent: [
      { title: 'サービス提供開始のお知らせ', released_at: '2025-08-01', page_view: 620, clip_count: 0 },
    ],
  };
}
...
export function mockPeriodCurve() {
  return {
    rows: [
      { months: 3,  companies: 22018, hit_pct: 13, releases_p50: 1, cum_pv_p50: 21, cum_pv_p90: 95 },
      { months: 6,  companies: 21322, hit_pct: 14, releases_p50: 2, cum_pv_p50: 27, cum_pv_p90: 130 },
      { months: 12, companies: 20100, hit_pct: 16, releases_p50: 2, cum_pv_p50: 35, cum_pv_p90: 209 },
      { months: 24, companies: 17834, hit_pct: 19, releases_p50: 3, cum_pv_p50: 47, cum_pv_p90: 383 },
      { months: 36, companies: 15680, hit_pct: 23, releases_p50: 4, cum_pv_p50: 58, cum_pv_p90: 591 },
    ],
  };
}
...
export function mockResume() {
  return {
    segments: [
      { seg: 1, from_n: 1,  to_n: 1,  companies: 4291, hit_before_pct: 9,  hit_after_pct: 44, added_p50: 3 },
      { seg: 2, from_n: 2,  to_n: 3,  companies: 2667, hit_before_pct: 12, hit_after_pct: 48, added_p50: 4 },
      { seg: 3, from_n: 4,  to_n: 10, companies: 1995, hit_before_pct: 19, hit_after_pct: 53, added_p50: 6 },
      { seg: 4, from_n: 11, to_n: 99, companies: 1264, hit_before_pct: 42, hit_after_pct: 67, added_p50: 10 },
    ],
    gaps: [
      { gap: '6〜9か月', companies: 2382 }, { gap: '9〜12か月', companies: 1672 },
      { gap: '1〜2年', companies: 3492 }, { gap: '2年以上', companies: 2671 },
    ],
    total_resumed: 10217,
  };
}
...
export function mockUnused() {
  return {
    items: [
      {
        key: 'keyword', label: 'キーワード設定', detected: '0件',
        impact: { metric: 'clip_rate', with: 34, without: 17, ratio: 2.0, n: 268 },
      },
      { key: 'main_image', label: 'メイン画像', detected: '未設定', impact: null },
